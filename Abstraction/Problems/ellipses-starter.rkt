...
;;
;; https://s3.amazonaws.com/edx-course-spdx-kiczales/HTC/problems/ellipses-f.PNG
;;
...
(foldr beside BLANK (build-list 20 create))

(@problem 3)
;; By just using a different built in list function write an expression 
;; to put the ellipses beside each other in a single image like this:
;;
;; https://s3.amazonaws.com/edx-course-spdx-kiczales/HTC/problems/ellipses-b.PNG

(foldl beside BLANK (build-list 20 create))