...
;; given and (list n0 n1 ...) produce (list (fn n0) (fn n1) ...)
...
(check-expect (map2 string-length (list "a" "ab" "abc"))
                    (list 1 2 3))
...
;; given fn and list, produce list of the elements that satisfies fn
(check-expect (filter2 positive? empty) empty)
(check-expect (filter2 positive? (list 1 3 2 -2)) (list 1 3 2))
(check-expect (filter2 negative? (list 1 -3 2 -4)) (list -3 -4))
