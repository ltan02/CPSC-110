...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname lec01-functions-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(silly (* 1 3)) 
(silly 3)       ;call * w/ 1 and 3
(* 2 (sqr 3))   ;function call - replace call w/ body 
(* 2 9)         ;call sqr primitive with 3
18              ;call * primitive with 2 and 9
