...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname lec01-primitives-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))

(require 2htdp/image)

;; l01-primitives-solution.rkt
