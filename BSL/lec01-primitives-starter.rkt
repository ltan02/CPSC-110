...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname lec01-primitives-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))

(require 2htdp/image)

;; l01-primitives-starter.rkt
...
(beside (rectangle 15 30 "solid" "red")
        (rectangle 30 30 "solid" "white")
        (rectangle 15 30 "solid" "red"))
