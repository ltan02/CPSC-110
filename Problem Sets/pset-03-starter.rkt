...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname pset-03-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (render-ball B1) (place-image BALL
                                            (ball-x B1)
                                            (ball-y B1)
                                            MTS))
...
(check-expect (touch-bottom? (make-ball RIG (- BOT 5) -3 4)) false)
(check-expect (touch-bottom? (make-ball RIG (- BOT 4) -3 4)) true)
(check-expect (touch-bottom? (make-ball RIG (- BOT 1) -3 2)) true)
(check-expect (touch-bottom? (make-ball RIG (- BOT 0) -3 -2)) false) 
...
(check-expect (bounce-bottom (make-ball (- LEF 2) (- BOT 4) 2 5))
              (make-ball (- LEF 2) (- BOT 1) 2 -5))
(check-expect (bounce-bottom (make-ball (- LEF 6) (- BOT 10) 4 11))
              (make-ball (- LEF 6) (- BOT 1) 4 -11))
...
(check-expect (bounce-left (make-ball (+ LEF 4) (+ TOP 4) -5 3))
              (make-ball (+ LEF 1) (+ TOP 4) 5 3))
(check-expect (bounce-left (make-ball (+ LEF 2) (+ TOP 5) -3 6))
              (make-ball (+ LEF 1) (+ TOP 5) 3 6))
...
(check-expect (bounce-right (make-ball (- RIG 6) (+ BOT 2) 7 2))
              (make-ball (- RIG 1) (+ BOT 2) -7 2))
(check-expect (bounce-right (make-ball (- RIG 4) (+ BOT 1) 5 4))
              (make-ball (- RIG 1) (+ BOT 1) -5 4))
...
(check-expect (glide (make-ball 10 12 4 3))
              (make-ball 14 15 4 3))
(check-expect (glide (make-ball 200 300 -2 3))
              (make-ball 198 303 -2 3))
(check-expect (glide (make-ball 200 4 -1 -2))
              (make-ball 199 2 -1 -2))
(check-expect (glide (make-ball 429 248 4 -5))
              (make-ball 433 243 4 -5))
#;
(define (glide b) b)
