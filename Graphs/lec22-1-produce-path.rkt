...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname lec22-1-produce-path) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
