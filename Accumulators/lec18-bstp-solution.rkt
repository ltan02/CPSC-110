...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname lec19-bstp-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
;;
;; PROBLEM:
;;
