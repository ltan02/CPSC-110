...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname lec18-bstp-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
;;
;; PROBLEM:
;;
