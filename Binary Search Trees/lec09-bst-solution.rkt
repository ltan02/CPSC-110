...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname lec11-bst-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
(require spd/tags)
...
;; produce val associated w/ key or false if none
