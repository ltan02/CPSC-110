...
;;
;; https://s3.amazonaws.com/edx-course-spdx-kiczales/HTC/problems/cantor1.PNG
;;
;; (cantor (* CUTOFF 3)) produces:
;;
;; https://s3.amazonaws.com/edx-course-spdx-kiczales/HTC/problems/cantor2.PNG
;;
;; And that keeps building up to something like the following. So
;; as it goes it gets wider and taller of course.
;;
;; https://s3.amazonaws.com/edx-course-spdx-kiczales/HTC/problems/cantor3.PNG
;;
;; PROBLEM A:
;;
