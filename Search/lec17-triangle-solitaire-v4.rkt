...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname lec17-triangle-solitaire-v4) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
